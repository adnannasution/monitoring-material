...
execute("""
        CREATE TABLE IF NOT EXISTS joblist_taex (
            ...
            joblist_detail_reason_name    TEXT,
            document_joblist_type_id      TEXT,
            document_joblist_type_name    TEXT,
            no_document                   TEXT,
            ...
            duration_ta_brick_value       TEXT,
            duration_ta_brick_text        TEXT,
            project_status                TEXT,
            equipment_no                  TEXT,
            unit_id                       TEXT,
            area_name                     TEXT,
            ...
            location                      TEXT,
            description_of_tech_object    TEXT,
            ...
            planning_jasa_status_name     TEXT,
            planning_material_status_name TEXT,
            "order"                       TEXT,
            no_package                    TEXT,
    ...
    for sql in [
        ...
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_sap_pr_upsert ON sap_pr(pr, item)',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_prisma_upsert   ON prisma_reservasi(\"order\", itm, material)',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_kumpulan_upsert  ON kumpulan_summary(\"order\", itm, material)',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_work_order_upsert ON work_order(\"order\")',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_sap_po_upsert     ON sap_po(po, po_item)',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_vw_jl_wo_upsert   ON vw_joblist_wo(\"order\")',
        'CREATE UNIQUE INDEX IF NOT EXISTS idx_vw_jld_upsert     ON vw_joblist_detail(id)',
        ...
        'CREATE INDEX IF NOT EXISTS idx_joblist_taex_package    ON joblist_taex(no_package)',
    ]:
        try:
            execute(sql)
        except Exception:
