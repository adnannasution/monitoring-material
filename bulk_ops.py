        ...
        with conn.cursor() as cur:
            ...
            sql = """
                ...
                ON CONFLICT ("order", material, itm) DO UPDATE SET
                    plant                = COALESCE(EXCLUDED.plant,                taex_reservasi.plant),
                    equipment            = COALESCE(EXCLUDED.equipment,            taex_reservasi.equipment),
                    revision             = COALESCE(EXCLUDED.revision,             taex_reservasi.revision),
                    material_description = COALESCE(EXCLUDED.material_description, taex_reservasi.material_description),
                    qty_reqmts           = COALESCE(EXCLUDED.qty_reqmts,           taex_reservasi.qty_reqmts),
                    qty_stock            = COALESCE(EXCLUDED.qty_stock,            taex_reservasi.qty_stock),
                    pr                   = COALESCE(EXCLUDED.pr,                   taex_reservasi.pr),
                    item                 = COALESCE(EXCLUDED.item,                 taex_reservasi.item),
                    qty_pr               = COALESCE(EXCLUDED.qty_pr,               taex_reservasi.qty_pr),
                    cost_ctrs            = COALESCE(EXCLUDED.cost_ctrs,            taex_reservasi.cost_ctrs),
                    po                   = COALESCE(EXCLUDED.po,                   taex_reservasi.po),
                    po_date              = COALESCE(EXCLUDED.po_date,              taex_reservasi.po_date),
                    qty_deliv            = COALESCE(EXCLUDED.qty_deliv,            taex_reservasi.qty_deliv),
                    delivery_date        = COALESCE(EXCLUDED.delivery_date,        taex_reservasi.delivery_date),
                    sloc                 = COALESCE(EXCLUDED.sloc,                 taex_reservasi.sloc),
                    del                  = COALESCE(EXCLUDED.del,                  taex_reservasi.del),
                    fis                  = COALESCE(EXCLUDED.fis,                  taex_reservasi.fis),
                    ict                  = COALESCE(EXCLUDED.ict,                  taex_reservasi.ict),
                    pg                   = COALESCE(EXCLUDED.pg,                   taex_reservasi.pg),
                    recipient            = COALESCE(EXCLUDED.recipient,            taex_reservasi.recipient),
                    unloading_point      = COALESCE(EXCLUDED.unloading_point,      taex_reservasi.unloading_point),
                    reqmts_date          = COALESCE(EXCLUDED.reqmts_date,          taex_reservasi.reqmts_date),
                    qty_f_avail_check    = COALESCE(EXCLUDED.qty_f_avail_check,    taex_reservasi.qty_f_avail_check),
                    qty_withdrawn        = COALESCE(EXCLUDED.qty_withdrawn,        taex_reservasi.qty_withdrawn),
                    uom                  = COALESCE(EXCLUDED.uom,                  taex_reservasi.uom),
                    gl_acct              = COALESCE(EXCLUDED.gl_acct,              taex_reservasi.gl_acct),
                    res_price            = COALESCE(EXCLUDED.res_price,            taex_reservasi.res_price),
                    res_per              = COALESCE(EXCLUDED.res_per,              taex_reservasi.res_per),
                    res_curr             = COALESCE(EXCLUDED.res_curr,             taex_reservasi.res_curr),
                    reservno             = COALESCE(EXCLUDED.reservno,             taex_reservasi.reservno),
                    vendor               = COALESCE(EXCLUDED.vendor,               taex_reservasi.vendor),
                    updated_at           = NOW()
            """
